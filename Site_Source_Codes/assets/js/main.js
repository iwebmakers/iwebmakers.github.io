...
if ($('#btn-content').val() == "display_current_date_time") {
  
}
var display_current_date_time = '<iframe src="Display-Current-Time-and-Date.html" class="content-frame" frameborder=""></iframe>';
